...
class CharsTest {
    ...
    public void test_char_anyOf() {
        ...
        var ctx3 = Context.of("c");
        result = abc.parse(ctx3);
        assertParsed(result, 'c');

        var ctx4 = Context.of("d");
